...
public class ShowAllNotificationsCommand implements Command {
    ...
    public ShowAllNotificationsCommand(AuthenticationManager authManager, NotificationServiceAPI notificationService,
    ...
    public String execute(String[] arguments, SocketChannel clientChannel) {
        ...
        List<Notification> allNotifications = notificationService.getAllNotificationsForUser(username);
        return notificationService.getNotificationsToString(allNotifications);
    }
}
