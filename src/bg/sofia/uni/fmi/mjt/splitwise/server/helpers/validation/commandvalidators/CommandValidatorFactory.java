...
import bg.sofia.uni.fmi.mjt.splitwise.server.helpers.validation.commandvalidators
    .authentication.LogOutCommandValidator;
import bg.sofia.uni.fmi.mjt.splitwise.server.helpers.validation.commandvalidators
    .authentication.LoginCommandValidator;
import bg.sofia.uni.fmi.mjt.splitwise.server.helpers.validation.commandvalidators
    .authentication.RegisterCommandValidator;
import bg.sofia.uni.fmi.mjt.splitwise.server.helpers.validation.commandvalidators
    .friend.AddFriendCommandValidator;
import bg.sofia.uni.fmi.mjt.splitwise.server.helpers.validation.commandvalidators
    .friend.AddObligationWithFriendCommandValidator;
import bg.sofia.uni.fmi.mjt.splitwise.server.helpers.validation.commandvalidators
    .friend.AreFriendsCommandValidator;
import bg.sofia.uni.fmi.mjt.splitwise.server.helpers.validation.commandvalidators
...
import bg.sofia.uni.fmi.mjt.splitwise.server.helpers.validation.servicevalidators.NotificationValidator;
...
public class CommandValidatorFactory {
    ...
    private CommandValidatorFactory(AuthenticationManager authManager, ServiceValidatorFactory validatorFactory) {
        ...
        validators.put("add-friend-to-group",
            new AddFriendToGroupCommandValidator(authManager, groupValidator, userValidator));
        ...
        validators.put("all-notifications", new ShowAllNotificationsCommandValidator(authManager));
        validators.put("notifications", new ShowNewNotificationsCommandValidator(authManager));
