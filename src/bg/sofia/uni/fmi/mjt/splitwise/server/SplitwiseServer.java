...
public class SplitwiseServer {
    ...
    public SplitwiseServer(int port) {
        ...
        CurrencyConverter currencyConverter = new CurrencyConverter(exchangeRateFetcher, "BGN");
        ...
        ObligationServiceAPI obligationService =
            new ObligationService(userService, currencyConverter, JsonProcessorFactory.getObligationJsonProcessor());
    ...
    private void handleClientRequests() throws IOException {
        ...
        while (keyIterator.hasNext()) {
            ...
            if (key.isReadable()) {
                ...
                String response = commandProcessor.processClientInput(clientInput, clientChannel);
    ...
    private void configureServerSocketChannel(ServerSocketChannel serverSocketChannel, Selector selector)
        throws IOException {
    ...
    private void writeClientOutput(SocketChannel clientChannel, String output) throws IOException {
        ...
        output = output.stripTrailing();  // remove trailing \n
        output += System.lineSeparator() + System.lineSeparator(); // Ensure a newline to signal the end of the message
//        if (!output.endsWith("\n")) {
//            output += "\n";
//        }
