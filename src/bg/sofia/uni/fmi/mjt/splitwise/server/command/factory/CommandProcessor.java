...
public class CommandProcessor {
    ...
    public String processClientInput(String clientInput, SocketChannel clientChannel) {
        try {
            ...
            String currentUser = authManager.isAuthenticated(clientChannel) ?
                authManager.getAuthenticatedUser(clientChannel).getUsername() : "Unknown";
            ...
            String currentUser = authManager.isAuthenticated(clientChannel) ?
                authManager.getAuthenticatedUser(clientChannel).getUsername() : "Unknown";
            LoggerUtil.logError(e.getMessage() + " " + clientInput, e, currentUser);
            return UNEXPECTED_ERROR_MESSAGE + System.lineSeparator() + e.getMessage();
        }
