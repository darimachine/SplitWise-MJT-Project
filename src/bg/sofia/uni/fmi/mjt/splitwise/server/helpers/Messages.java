...
public class Messages {
    //Welcome Messages
    public static final String PLEASE_LOGIN_OR_REGISTER_MESSAGE = "Please register or login to get started.";
    ...
    public static final String NON_EMPTY_LOGIN_FIELDS_MESSAGE = "Login fields cannot be empty!";
    //LogOut
    public static final String INVALID_LOGOUT_COMMAND_MESSAGE = "Invalid logout command! Usage: logout";

    //AddFriend
    public static final String INVALID_ADD_FRIEND_COMMAND_MESSAGE =
        "Invalid add-friend command! Usage: add-friend <username>";

    public static final String CANNOT_ADD_SELF_AS_FRIEND_MESSAGE = "You cannot add yourself as a friend!";
    //RemoveFriend
    ...
    public static final String CANNOT_REMOVE_SELF_AS_FRIEND_MESSAGE = "You cannot remove yourself as a friend!";
    //my-friends
    public static final String INVALID_SHOW_FRIENDS_COMMAND_MESSAGE = "Invalid my-friends command! Usage: my-friends";
    //AreFriends
    ...
    public static final String CANNOT_ADD_SELF_TO_GROUP_MESSAGE = "You cannot add yourself to the group!";
    ...
    public static final String INVALID_AMOUNT_MESSAGE = "Invalid amount! The amount must be a positive number.";
    //Split with Group
    ...
    public static final String INVALID_SWITCH_CURRENCY_COMMAND_MESSAGE =
        "Invalid command! Usage: switch-currency <CURRENCY_CODE>";

    public static final String INVALID_CURRENT_CURRENCY_COMMAND_MESSAGE = "Invalid command! Usage: current-currency";
}
