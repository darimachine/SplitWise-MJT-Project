...
class ShowNewNotificationsCommandValidatorTest {

    private AuthenticationManager authManagerMock;
    private NotificationValidator notificationValidatorMock;
    private ShowNewNotificationsCommandValidator validator;
    ...
    void setUp() {
        ...
        validator = new ShowNewNotificationsCommandValidator(authManagerMock, notificationValidatorMock);
    ...
    @Test
    void testValidate_ThrowsNotificationNotFoundExceptionIfNoNewNotificationsExist() {
        ...
        doThrow(new NotificationNotFoundException("No new notifications found"))
            .when(notificationValidatorMock).validateUnseenNotificationExists("alex");

        String[] args = {"notifications"};

        assertThrows(NotificationNotFoundException.class, () -> validator.validate(args, clientChannelMock),
            "Should throw NotificationNotFoundException when there are no new notifications.");
    }
